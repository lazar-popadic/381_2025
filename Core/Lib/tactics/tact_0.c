...
int8_t tact_0() {
	...
	case 0: //krece prednjom stranom ka ms24
		...
		break;
	case 10:
		cur_task = move_on_path(x_side(700), -550, -90, FORWARD, 0, V_MAX_DEF,
				0, FORWARD);
	...
	case 120: //krece prednjom stranom ka ms14
		cur_task = move_on_path(x_side(-700), -550, 90, BACKWARD, 0, V_MAX_DEF,
				0, BACKWARD);
		if (cur_task == TASK_SUCCESS)
			tact_fsm_case = 140;
		break;
	...
	case 220: //krece prednjom stranom ka ms10
		...
		break;
	case 230:
		cur_task = move_on_path(x_side(-650), 600, -90, BACKWARD, 0, V_MAX_DEF,
				0, BACKWARD);
		if (cur_task == TASK_SUCCESS)
			tact_fsm_case = 240;
		break;
	...
	case 270: //krece zadnjom stranom ka ca1
		...
		break;
	case 280:
		cur_task = move_on_path(x_side(-700), -800, 90, BACKWARD, 0, V_MAX_DEF,
				0, BACKWARD);
		if (cur_task == TASK_SUCCESS)
			tact_fsm_case = 290;
		break;
	...
	case 310: //krece ka kraju
		...
		break;
	case 320:
		cur_task = move_on_path(x_side(-1100), 800, -90, BACKWARD, 0, V_MAX_DEF,
				0, BACKWARD);
		if (cur_task == TASK_SUCCESS)
			tact_fsm_case = 330;
		break;
	...
	case 1050: //krece ka ms21
		cur_task = move_on_path(x_side(600), 350, 180, BACKWARD, 1, V_MAX_DEF,
				0, BACKWARD);
		if (cur_task == TASK_SUCCESS)
			tact_fsm_case = 1060;
		if (cur_task == TASK_FAIL)
	...
	case 3580: //krece zadnjom stranom ka ms10
		...
		break;
	case 3590:
		cur_task = move_on_path(x_side(-650), 600, 90, FORWARD, 0, V_MAX_DEF,
				0, FORWARD);
		if (cur_task == TASK_SUCCESS)
			tact_fsm_case = 3600;
		if (cur_task == TASK_FAIL)
	...
	case 3630: //krece zadnjom stranom ka ca4
		...
		break;
	case 3640:
		cur_task = move_on_path(x_side(-300), -850, 90, BACKWARD, 0, V_MAX_DEF,
				0, BACKWARD);
		if (cur_task == TASK_SUCCESS)
			tact_fsm_case = 3650;
		break;
	...
	case 3700: //krece ka ms14
		...
		break;
	case 3710:
		cur_task = move_on_path(x_side(-700), -550, 0, BACKWARD, 0, V_MAX_DEF,
				0, BACKWARD);
		if (cur_task == TASK_SUCCESS)
			tact_fsm_case = 3720;
		break;
	...
	case 4150: //krece zadnjom stranom ka ca4
		...
		break;
	case 4160:
		cur_task = move_on_path(x_side(-300), -850, 90, FORWARD, 0, V_MAX_DEF,
				0, FORWARD);
		if (cur_task == TASK_SUCCESS)
			tact_fsm_case = 4170;
		break;
